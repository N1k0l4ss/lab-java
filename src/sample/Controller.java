...
public class Controller {
    ...
    void aClicked(ActionEvent event) {
        searchWindow();
        ObservableList<Customer> sortedByName = MySorts.sortA(customersObservableList, _parametr);
    ...
    void bClicked(ActionEvent event) {
        searchWindow();
        ObservableList<Customer> sorted = MySorts.sortB(customersObservableList, _parametr);
        if(sorted.isEmpty()){
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Ошибка!");
            alert.setHeaderText(null);
    ...
    void cClicked(ActionEvent event) {
        ObservableList<Customer> sortedObservable = MySorts.sortC(customersObservableList);
    ...
    void dClicked(ActionEvent event) {
        ObservableList<Customer> sortedObservable = MySorts.sortD(customersObservableList);
        table.setItems(sortedObservable);
    }
    @FXML
    void eClicked(ActionEvent event) {
        String str = MySorts.sortE(customersObservableList);
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Info");
        alert.setHeaderText(null);
    ...
    void fClicked(ActionEvent event) {
       ObservableList<Customer> sorted = MySorts.sortF(customersObservableList);
        table.setItems(sorted);
    }
